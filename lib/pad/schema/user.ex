defmodule Pad.User do
  ...
  schema "users" do
    ...
    has_many :pads, Pad.Password, references: :username
    timestamps()
  end
  ...
  def get_user(user) when is_bitstring(user), do: Repo.get(__MODULE__, user)
  def get_user(%__MODULE__{} = user), do: user
